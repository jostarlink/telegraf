class Composer {
  ...
  static hears (match, middleware) {
    return Composer.mount('text', Composer.match(convertMath(match), middleware))
  }

  static action (match, middleware) {
    return Composer.mount('callback_query', Composer.match(convertMath(match), middleware))
  }
